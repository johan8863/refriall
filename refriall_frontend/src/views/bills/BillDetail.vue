                ...
                <div
                  ...
                  class="row px-3 py-1">
                    ...
                    <div v-if="paginatedBill.customer" class="col-md-9 border-bottom border-2 mb-1">
                        ...
                        <span class="d-block">{{ paginatedBill.customer.province }}</span>
                        <span class="d-block">{{ paginatedBill.customer.township }}</span>
                    </div>
                    ...
                    <div v-if="paginatedBill.customer_dependency" class="col-md-9 border-bottom border-2 mb-1">
                        ...
                        <span class="d-block">{{ paginatedBill.customer_dependency.province }}</span>
                        <span class="d-block">{{ paginatedBill.customer_dependency.township }}</span>
                    </div>
                    ...
                    <div class="col-md-12" style="height: 695px;">
                        <table class="table">
...
const prepareBillToPaginate = (billToPaginate, bill) => {
    ...
    billToPaginate.value.get_total_amount_product = bill.value.get_total_amount_product
...
const paginate = (bill, itemsPerPage, start=0, pages=[]) => {
    ...
    pages.push({
        ...
        get_total_amount_product: bill.value.get_total_amount_product,
