    ...
    <div v-else class="col-md-9">
      ...
      <div id="order-to-pdf">
        ...
        <div v-for="(paginatedOrder, index) of paginatedOrders" :key="index" class="row px-3 py-1">
          ...
          <div class="col-md-3 justify-content center border-bottom border-2 mb-1">
            <span class="d-block"> Reparación: <span v-if="paginatedOrder.repair">X</span> </span>
          </div>

          <div class="col-md-3 justify-content center border-bottom border-2 mb-1">
            <span class="d-block"> Instalación: <span v-if="paginatedOrder.install">X</span> </span>
          </div>

          <div class="col-md-3 justify-content center border-bottom border-2 mb-1">
            <span class="d-block"> Mtto: <span v-if="paginatedOrder.maintenance">X</span> </span>
          </div>
          ...
          <div class="col-md-5">
            ...
            <div class="row">
              <div class="col-md-6">
                <span class="d-block"
                  >Rev/Diag.: {{ paginatedOrder.get_total_amount_revision.toFixed(2) }}</span
                >
                <span class="d-block"
                  >Partes: {{ paginatedOrder.get_total_amount_prod.toFixed(2) }}</span
                >
                <span class="d-block"
                  >Conceptos: {{ paginatedOrder.get_total_amount_concept.toFixed(2) }}</span
                >
                <span class="d-block"
                  >Reparación: {{ paginatedOrder.get_total_amount_repair.toFixed(2) }}</span
                >
              </div>
              <div class="col-md-6">
                <span class="d-block"
                  >Mtto: {{ paginatedOrder.get_total_amount_maintenace.toFixed(2) }}</span
                >
                <span class="d-block"
                  >Instalación: {{ paginatedOrder.get_total_amount_install.toFixed(2) }}</span
                >
                <span class="d-block"
                  >Montaje/Desm: {{ paginatedOrder.get_total_amount_unmounting.toFixed(2) }}</span
                >
              </div>
            </div>
          </div>
