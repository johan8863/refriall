...
It is always suggested to have [git](https://git-scm.com/) installed so that you can update the software by just pulling updates, no to download the compressed project from time to time. Follow instructions [here](https://git-scm.com/install/) to install on your operating system.
